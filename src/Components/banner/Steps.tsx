...
export const Steps = () => {
  return (
    <div className="flex flex-col justify-between items-center gap-3 text-secondary mb-4 h-full pb-8">
      ...
      <div className="mt-10 w-full ml-8">
        <Button
          label="Book Now"
          className="bg-primary justify-center text-black-secondary w-[100px] xs:w-[150px] text-center py-2 px-4 rounded-lg inline-flex items-center shadow-lg font-bold "
          spanClass="text-sm"
        />
      </div>
    </div>
